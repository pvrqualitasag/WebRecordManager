...
<html>
    ...
    <body>
        <jsp:useBean id="qualifierBean" type="ch.asridt.record.RecordQualifier" scope="session" />
        <div class="container">
            <div class="page-header">
                <h1>Record Manager <small class="hidden-xs">- Settings</small></h1>
            </div>
            <form method="post" action="/WebRecordManager/RecordController?action=newSettings" class="settings-form">
                <input type="hidden">
                <label>Type: </label>
                <table>
                    <tr>
